function [new_lb,branch_name,matrix,hit]=findlb_box(p,matrix_name,matrix_store)
...
if length(p_mean)>k
    while wucha>0.1
        ...
        min_diag=diag(is_name2.*cn_diag');
